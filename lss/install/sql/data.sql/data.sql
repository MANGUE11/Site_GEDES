...
CREATE TABLE IF NOT EXISTS `lssx1_applications` (
...
CREATE TABLE IF NOT EXISTS `lssx1_events_event` (
...
CREATE TABLE IF NOT EXISTS `lssx1_events_eventvalue` (
  `EventId` int(11) NOT NULL AUTO_INCREMENT,
  `EventCategory` varchar(50) DEFAULT NULL,
  `EventName` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `lssx1_events_eventperiod` (
  `EventId` int(11) NOT NULL AUTO_INCREMENT,
  `EventCategory` varchar(50) DEFAULT NULL,
  `EventName` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `lssx1_events_log` (
  `EventId` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lssx1_events_customdata` (
  `EventId` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lssx1_events_exception` (
  `EventId` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lssx1_events_install` (
  `EventId` int(11) NOT NULL AUTO_INCREMENT,
  `SessionId` varchar(36) NOT NULL,
  `UtcTimestamp` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`EventId`)
...
CREATE TABLE IF NOT EXISTS `lssx1_events_uninstall` (
  `EventId` int(11) NOT NULL AUTO_INCREMENT,
  `SessionId` varchar(36) NOT NULL,
  `UtcTimestamp` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`EventId`)
...
CREATE TABLE IF NOT EXISTS `lssx1_locales` (
...
CREATE TABLE IF NOT EXISTS `lssx1_options` (
...
CREATE TABLE IF NOT EXISTS `lssx1_sessions` (
  `SessionKey` int(11) NOT NULL AUTO_INCREMENT,
  `SessionId` varchar(36) NOT NULL,
  `UniqueUserId` varchar(36) NOT NULL,
  `StartApp` TIMESTAMP NULL DEFAULT NULL,
  `StopApp` TIMESTAMP NULL DEFAULT NULL,
  `ApplicationId` varchar(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `lssx1_uniqueusers` (
  `UniqueUserKey` int(11) NOT NULL AUTO_INCREMENT,
  `UniqueUserId` varchar(36) NOT NULL,
  `Created` TIMESTAMP NULL DEFAULT NULL,
  `LastRecieved` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `lssx1_users` (
...
INSERT IGNORE INTO `lssx1_locales` (`LCID`, `DisplayName`, `ShortCode`) VALUES
(1078, 'Afrikaans ', 'af '),
(1052, 'Albanian ', 'sq '),
